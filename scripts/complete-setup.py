...
def create_directories():
    ...
    # PRPs subdirectories
    prps_dirs = ["planning", "architecture", "contracts", "security", "implementation"]
    ...
    # Reports directories
    reports_dirs = ["reports/daily", "reports/phase-completions", "reports/metrics"]
...
def initialize_json_files():
    ...
    # Sync files
    sync_files = {
        "broadcasts.json": {"version": "1.0.0", "broadcasts": []},
        "handoffs.json": {"version": "1.0.0", "handoffs": []},
        "conflicts.json": {"version": "1.0.0", "conflicts": []},
    }
    ...
    for agent in AGENTS:
        ...
        # Agent tasks file
        agent_tasks = {"assigned": [], "completed": [], "in_progress": []}
        ...
        with open(changelog_path, "w") as f:
            ...
            f.write("*No sessions yet*\n")

        print(f"✓ Initialized agent files: {agent}")

    # Workspace feature index
    feature_index = {"version": "1.0.0", "features": {}, "shared_components": []}
