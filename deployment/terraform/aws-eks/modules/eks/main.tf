...
resource "aws_eks_node_group" "main" {
  ...
  # Allow external changes to desired size without causing plan diff
  lifecycle {
...
resource "aws_eks_addon" "addons" {
  ...
  addon_version            = each.value.most_recent ? data.aws_eks_addon_version.this[each.key].version : null
